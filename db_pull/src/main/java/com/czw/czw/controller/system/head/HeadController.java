package com.czw.czw.controller.system.head;
...
//			String strEM[] = strEMAIL.split(",ly,");
//			if(strEM.length == 4){
...
//			String strFW[] = strFWATERM.split(",ly,");
//			if(strFW.length == 5){
...
//			String strIW[] = strIWATERM.split(",ly,");
//			if(strIW.length == 4){
...
//		Tools.writeFile(Const.EMAIL,pd.getString("SMTP")+",ly,"+pd.getString("PORT")+",ly,"+pd.getString("EMAIL")+",ly,"+pd.getString("PAW"));	//写入邮件服务器配置
//		Tools.writeFile(Const.SMS1,pd.getString("SMSU1")+",ly,"+pd.getString("SMSPAW1"));	//写入短信1配置
//		Tools.writeFile(Const.SMS2,pd.getString("SMSU2")+",ly,"+pd.getString("SMSPAW2"));	//写入短信2配置
//		mv.addObject("msg","OK");
...
//		PageData pd = new PageData();
//		pd = this.getPageData();
//		Tools.writeFile(Const.FWATERM,pd.getString("isCheck1")+",ly,"+pd.getString("fcontent")+",ly,"+pd.getString("fontSize")+",ly,"+pd.getString("fontX")+",ly,"+pd.getString("fontY"));	//文字水印配置
//		Tools.writeFile(Const.IWATERM,pd.getString("isCheck2")+",ly,"+pd.getString("imgUrl")+",ly,"+pd.getString("imgX")+",ly,"+pd.getString("imgY"));	//图片水印配置
//		Watermark.fushValue();
//		mv.addObject("msg","OK");
//		mv.setViewName("save_result");
//		return mv;
