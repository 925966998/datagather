	...
	$("[validate]").each(function() {
		if ($(this).attr("validate") == "num") {
			...
			if ($(this).val().trim() == "") {
				isCheck = false;
				// 如果是隐藏域在父容器显示
				var a=document.getElementById("ACTIVITY_IMG");
				alert(a);
												...
												.uploadify(
														{
															...
															'folder' : "/uploadFiles/uploadImgs/activeIMG/"
															...
															'buttonText' : "files",
															'scriptData' : {
																'uploadPath' : '/uploadFiles/uploadImgs/activeIMG/'
																		+ str
																		+ '/'
															...
															'onComplete' : function(
																...
																var p = $(
																		...
																		.parent()
																		.parent();
																var path = '/uploadFiles/uploadImgs/activeIMG/'
																		+ str
																		+ '/'
																		+ response
																				.trim();
