  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<table>
				<tr>
					...
					<td style="vertical-align:top;"><a class="btn btn-mini btn-light" onclick="window.location.href='<%=basePath%>/user/listtabUsers';" title="切换模式"><i id="nav-search-icon" class="icon-exchange"></i></a></td>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function editUser(user_id){
			 ...
			 diag.Drag=true;
			 diag.Title ="资料";
			 diag.URL = '<%=basePath%>user/goEditU?USER_ID='+user_id;
			 diag.Width = 225;
			 diag.Height = 415;
			 diag.CancelEvent = function(){ //关闭事件
				 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
