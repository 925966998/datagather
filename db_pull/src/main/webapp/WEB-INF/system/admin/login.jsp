...
<meta property="qc:admins" content="1374452377645257605274771674747716" />
...
<body>
	...
	<div
		...
		<div id="loginbox">
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">wanchuang © 2016</span></font>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var yzm="123";//$("#code").val()
				var code = ""+loginname+",ly,"+password+""+",ly,"+yzm;
				$.ajax({
					type: "POST",
					url: 'login_login',
