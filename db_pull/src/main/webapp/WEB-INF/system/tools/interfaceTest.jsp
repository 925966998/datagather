					...
					<div class="step-content row-fluid position-relative">
						<div style="float: left;">
							<span class="input-icon">
								<input type="text" id="serverUrl" title="输入请求地址" value="<%=basePath%>/appuser/getAppuserByUm?USERNAME=dsfsd" style="width:540px;">
					...
					<div class="step-content row-fluid position-relative">
						<ul class="unstyled spaced2">
							...
							<li class="text-warning green"><i class="icon-star blue"></i>
								校验加密规则：(取其中一个参数名+当前日期[格式 20150405]+混淆码",ly," 然后md5加密 的值作为 参数FKEY的值提交)
							</li>
						</ul>
					</div>
