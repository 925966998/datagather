...
public class FzncsService {
    ...
    @Transactional("targetTransactionManager")
    public List<Map<String, Object>> fzncsxx(String KJDZZBBH, List<Map<String, Object>> GL_YebList,
        ...
        for (Map<String, Object> pd : GL_YebList
            ...
            this.fzncsbBase(dataPullBase, pd, dzzbxxList);
    ...
    public Map<String, Object> fzncsbBase(Map<String, Object> dataPullBase, Map<String, Object> pd, List<Map<String, Object>> dzzbxxList) {
        Map<String, Object> datadzzbxx = dzzbxxList.get(0);
    ...
    public Map<String, Object> fzncspageDataGL_Fzxzl(Map<String, Object> dataPull, List<Map<String, Object>> pageDataGL_Fzxzl) {
    ...
    public Map<String, Object> fzncspageDataPUBBMXX(Map<String, Object> dataPull, List<Map<String, Object>> pageDataPUBBMXX) {
    ...
    public Map<String, Object> fzncspageDataPUBKSZL(Map<String, Object> dataPull, List<Map<String, Object>> pageDataPUBKSZL) {
    ...
    public Map<String, Object> fzncspageDataGL_Xmzl(Map<String, Object> dataPull, List<Map<String, Object>> pageDataGL_Xmzl) {
        if (pageDataGL_Xmzl != null && pageDataGL_Xmzl.size() > 0) {
            dataPull.put("FZBM", pageDataGL_Xmzl.get(0).get("XMDM"));
            dataPull.put("FZMC", pageDataGL_Xmzl.get(0).get("XMMC"));
        }
    ...
    public Map<String, Object> fzncspageDataGL_KMXX(Map<String, Object> dataPullBase, List<Map<String, Object>> pageDataGL_Ztcs, List<Map<String, Object>> pageDataGL_KMXX, Map<String, Object> pd) {
