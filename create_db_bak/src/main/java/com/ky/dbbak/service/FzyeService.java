...
//                    lbdm,lbmc,lbfj
                                ...
                                if (fzlxjgStr != null && fzlxjgStr.length > 0) {
                                    for (int w = 0; w < fzlxjgStr.length; w++) {
                                        ...
                                        if (num1 < fzdm.length()) {
                                            ...
                                            dataPull.put("SJFZBM", maps.get(0).get("bmdm").toString().trim());
                                            jc++;
                                        }
                                    }
                                }
                                    ...
                                    for (int w = 0; w < fzlxjgStr.length; w++) {
                                        ...
                                        if (num1 < fzdm.length()) {
                                            ...
                                            if (FzyeBBH == 1) {
                                                ...
                                                dataPull.put("SJFZBM", maps.get(0).get("XMDM").toString().trim());
                                            } else if (FzyeBBH == 2) {
                                    ...
                                    for (int w = 0; w < fzlxjgStr.length; w++) {
                                        ...
                                        if (num1 < fzdm.length()) {
                                            ...
                                            if (maps.size() > 0 && maps != null) {
                                                ...
                                                dataPull.put("SJFZBM", maps.get(0).get("dwdm").toString().trim());
                                            }
                                            jc++;
                                        }
                                    }
                ...
                for (int q = 4; q < 31; q++) {
                    ...
                    if (pd.get("fzdm" + q) != null && !StringUtils.isEmpty(pd.get("fzdm" + q).toString().trim())) {
                        ...
                        String result = pd.get("fzdm" + q).toString().trim();
                        int numx = 0;
                        for (int w = 0; w < lbfjStr.length; w++) {
