...
//                        List<String> pageDataGL_KMXX1 = sourceMapper._queryGL_KMXX1(queryPd);
    ...
    public List<Map<String, Object>> kjqjdyService(String KJDZZBBH){
        ...
        if (pubKjqjList != null && pubKjqjList.size()>0){
    ...
    public List<Map<String, Object>> kmncsService(String KJDZZBBH){
        Map<String, Object> pageData = new HashMap<String, Object>();
        List<Map<String, Object>> resultList = new ArrayList<>();
        pageData.put("KJDZZBBH", KJDZZBBH);
        List<OrgEntity> orgEntities = orgMapper._querySuo(KJDZZBBH);
        ...
        return resultListNew2;
    }

    public List<Map<String, Object>> kmyeService(String KJDZZBBH){
        Map<String, Object> pageData = new HashMap<String, Object>();
        List<Map<String, Object>> resultList = new ArrayList<>();
        pageData.put("KJDZZBBH", KJDZZBBH);
        List<Map<String, Object>> dzzbxxList = dzzbxxMapper._queryDzzbxx(pageData);
    ...
    public List<Map<String, Object>> jzpzService(String KJDZZBBH){
        Map<String, Object> pageData = new HashMap<String, Object>();
        List<Map<String, Object>> resultList = new ArrayList<>();
        pageData.put("KJDZZBBH", KJDZZBBH);
        List<Map<String, Object>> dzzbxxList = dzzbxxMapper._queryDzzbxx(pageData);
...
//                String kmmc = pageDataGL_KMXX.get(0).get("kmmc").toString();
                ...
                if (!StringUtils.isEmpty(kmdm) && kmdm != null) {
                    if (kmdm.length() == 4) {
                        ...
                        Map<String, Object> queryPd = new HashMap<String, Object>();
                        queryPd.put("kmdms", kmdms);
                        queryPd.put("kjnd",dzzbxxList.get(0).get("KJND"));
                        queryPd.put("gsdm", dzzbxxList.get(0).get("DWDM"));
                        List<String> pageDataGL_KMXX1 = sourceMapper._queryGL_KMXX1(queryPd);
