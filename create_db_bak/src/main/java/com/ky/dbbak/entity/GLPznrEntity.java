 ...
 * Create By Generator
 */
public class GLPznrEntity implements Serializable {
    private String gsdm; //
    private String ZTH; //
    private String kjqj; //
    private String pzly; //
    ...
    private Integer BXDID; //
    private String HTID; //
    private Integer ZCKPBH; //
    ...
    public void setBXDID (Integer  BXDID){
       this.BXDID=BXDID;
    }

    public  Integer getBXDID(){
       return this.BXDID;
    }
    ...
    public void setZCKPBH (Integer  ZCKPBH){
       this.ZCKPBH=ZCKPBH;
    }

    public  Integer getZCKPBH(){
       return this.ZCKPBH;
    }
    ...
    public void setHZFLH (Integer  HZFLH){
       this.HZFLH=HZFLH;
    }

    public  Integer getHZFLH(){
       return this.HZFLH;
    }
