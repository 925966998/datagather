...
public class PzfzmxSql extends BaseProvider {
    ...
    protected String[] getColumns() {
        return new String[]{
                "KJYF", "JZPZBH", "FLXH", "XZQHDM", "XZQHMC", "KJND", "DWMC", "DWDM", "KJDZZBBH", "KJDZZBMC", "JZLXBH", "JZPZZL", "JZPZHH", "JZPZZY", "KJTX", "KJKMBM", "KJKMMC", "FZLXMC", "FZBM", "FZMC", "FZQC", "YJFZBM", "EJFZBM", "SJFZBM", "SIJFZBM", "WJFZBM", "JFFSE", "DFFSE", "BZMC", "WBJFFSE", "WBDFFSE", "HL", "SL", "DJ","JZLXMC"
        };
    }
