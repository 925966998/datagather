...
public class OrgSql extends BaseProvider {
    ...
    protected String _query(Map map) {
        StringBuilder builder = new StringBuilder("select org.*,a.areaName as areaName from " + getTableName() + " org left join gl_area a on org.areaCode=a.areaCode where 1=1");
