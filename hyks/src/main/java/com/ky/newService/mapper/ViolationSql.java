...
/**
 * @className: ViolationSql
 * @description: TODO
 * @author: Lcj
 * @date: 2020-09-28 10:33
 */
public class ViolationSql extends BaseProvider {
    @Override
    ...
    protected String[] getColumns() {
        return new String[]{ "name", "opinion","supplierManageId", "startTime","dealTime","result"};
    }
    ...
    protected String _query(Map map) {
        ...
        if (StringUtils.isNotBlank(MapUtils.getString(map, "opinion"))) {
            builder.append(" and opinion = #{opinion}");
        }
        ...
        if (StringUtils.isNotBlank(MapUtils.getString(map, "dealTime"))) {
            builder.append(" and dealTime = #{dealTime}");
        }
        if (StringUtils.isNotBlank(MapUtils.getString(map, "result"))) {
            builder.append(" and result = #{result}");
        }
