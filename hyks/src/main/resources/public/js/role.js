obj = {
    ...
    sum: function () {
        $("#roleForm").form('submit', {
            url: "/ky-supplier/role/saveOrUpdate",
            onSubmit: function () {
            ...
            success: function (data) {
                ...
                if (data.code = '10000') {
                    ...
                    $.ajax({
                        url: '/ky-supplier/roleMenu/save?roleId=' + roleId,
                        type: 'POST',
                        dataType: 'json',
        ...
        if (rows.length > 0) {
            $.messager.confirm('确定删除', '你确定要删除你选择的记录吗？', function (flg) {
                if (flg) {
                    ...
                    $.ajax({
                        type: 'get',
                        url: "/ky-supplier/role/deleteMoney",
                        data: {
                            ids: ids.join(',')
                        },
                        beforesend: function () {
    ...
    delOne: function (id) {
        $.messager.confirm('提示信息', '是否删除所选择记录', function (flg) {
            if (flg) {
                $.ajax({
                    type: 'get',
                    url: '/ky-supplier/role/deleteOne',
                    data: {
                        id: id
                    },
                    beforesend: function () {
...
$("#table").datagrid({
    title: "数据列表",
    iconCls: "icon-left02",
    url: '/ky-supplier/role/queryPage',
    fitColumns: true,
    striped: true,
    pagination: true,
    pageSize: 10,
...
function queryTree(id) {
    $('#tree').tree({
        url: "/ky-supplier/menu/menuTree/" + id,
        method: "get",
        animate: true,
        checkbox: true,
        lines: true
