obj = {
    reBack:function(){
        $.ajax({
            url: '/ky-supplier/qualification/querySupplierId',
            data:{uploadFormId: getUrlParam('uploadFormId')},
            type:'GET',
            success:function (res) {
                console.log(res)
                window.location.href="../web/qualification.html?supplierManageId="+res
            }
        })
    },
...
$("#table").datagrid({
    method: "get",
    iconCls: "icon-left02",
    url: '/ky-supplier/qualification/readFile',
    ...
    columns: [[
        ...
        },
        {
            ...
            align: 'center',
            formatter: function (val, row) {
                h = '<a  id="add" data-id="98" class=" operA01" class="easyui-linkbutton"  onclick="obj.delOne(\'' + getUrlParam('uploadFormId') + '/' + row.name + '\')">删除</a> ';
                return h;
            }
        },
    ]],
