        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (res == "false") {
                    ...
                    window.location.href = "../web/file.html?uploadFormId=" + id
                }
            }
        })
    },
...
$("#table").datagrid({
    method: "get",
    iconCls: "icon-left02",
    url: '/ky-supplier/qualification/queryPage',
    ...
    columns: [[
        ...
        },
        {
            ...
            align: 'center',
            formatter: function (val, row) {
                f = '<a  id="look"   class=" operA"  class="easyui-linkbutton"  onclick="obj.fileQualifiation(\'' + row.id + '\')">预览/下载附件</a>';
                return f;
            }
        },
    ]],
