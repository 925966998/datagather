...
function openMes() {
    ...
    $.ajax({
        url: '/ky-supplier/sysUser/queryById?id=' + sessionStorage.getItem("userId"),
        type: 'get',
        dataType: 'json',
        success: function (data) {
            ...
            $("#companyName").val(data.supplierType);
            $("#operateName").val(data.companyName);
        },
...
function savePass() {
    $.ajax({
        url: '/ky-supplier/sysUser/updatePass',
        type: 'GET',
        data: {
            oldPass: $("#oldPass").val(),
            newPass: $("#newPass").val(),
...
$(function () {
    ...
    //     success: function (data) {
    //         var data = data.data;
    //         document.getElementById("operateName").innerHTML = data.companyName;
    //     },
    // })
