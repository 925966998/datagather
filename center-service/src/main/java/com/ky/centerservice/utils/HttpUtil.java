...
public class HttpUtil {
    ...
    static String proxyHost = "192.168.31.216";
    static int proxyPort = 8080;

    //String s1 = HttpUtil.sendPost1("http://192.168.192.17:34022/process", dataCheckAll);
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost1(String urlS, String param) {
        try {
...
//            out = new OutputStreamWriter(conn.getOutputStream(), "GBK");//如果参数有中文，这里最好设置下编码，要不会出现乱码
//            // 发送请求参数
//            out.write(param);
//            // flush输出流的缓冲
//            out.flush();
