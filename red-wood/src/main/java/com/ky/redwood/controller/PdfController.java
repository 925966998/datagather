...
public class PdfController {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            // 4.向文档中添加内容
            new PdfController().generatePDF(document);
    ...
    public void generatePDF(Document document) throws Exception {
        ...
        // 段落
        Paragraph paragraph = new Paragraph("临汾桂蒲木业", titlefont);
...
/*        // 添加图片
        ...
        // 表格
        PdfPTable table = createTable(new float[] { 80, 40, 40, 40, 40, 40, 40 });
        table.addCell(createCell("客户", headfont, Element.ALIGN_LEFT, 7, false));
        table.addCell(createCell("日期", headfont, Element.ALIGN_CENTER, 7, false));
        table.addCell(createCell("编号", headfont, Element.ALIGN_RIGHT, 7, false));
        table.addCell(createCell("名称", keyfont, Element.ALIGN_CENTER));
        table.addCell(createCell("规格", keyfont, Element.ALIGN_CENTER));
        table.addCell(createCell("型号", keyfont, Element.ALIGN_CENTER));
